...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        ...
        elif arg not in ["BaseModel", "User", "State", "City", "Amenity", "Review"]:
    ...
    def do_show(self, arg):
        ...
        if len(args) == 0:
            print("** class name missing **")
        elif args[0] not in ["BaseModel", "User", "State", "City", "Amenity", "Review"]:
            print("** class doesn't exist **")
        elif len(args) == 1:
    ...
    def do_all(self, arg):
        ...
        the class name."""
        if arg not in ["BaseModel", "User", "State", "City", "Amenity", "Review", ""]:
            print("** class doesn't exist **")
        else:
